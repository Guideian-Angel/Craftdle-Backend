...
INSERT INTO difficulties (name, color_code) VALUES
('Beginner', '55FF55'),
('Easy', '00AA00'),
('Normal', 'FFFF55'),
('Hard', 'FFAA00'),
...
INSERT INTO gamemodes (icon, name, description, difficulty) VALUES 
('Tutorial.png', 'Tutorial', "In this mode, players can learn the game's mechanics and controls.", 1),
('Classic.png', 'Classic', 'In this mode, you receive recipes as riddles, but only those that are not made by one type of material. Four different hints are available to help you solve them.', 3),
('Daily.png', 'Daily', 'Similar to Classic, but can only be played once per day. Keep your streak going!', 3),
('AllInOne.png', 'All in One', 'In this mode, you can receive any recipe as a riddle. Four different hints are available to help you solve it.', 4),
('Pocket.png', 'Pocket', 'Similar to All in One, but you must work with a 2x2 crafting table to solve the riddles.', 3),
('Resource.png', 'Resource', 'Similar to Classic, but with a limited supply of materials.', 2),
('Hardcore.png', 'Hardcore', 'Similar to Classic, but no hints are available, and the game is played with health points.', 5);
